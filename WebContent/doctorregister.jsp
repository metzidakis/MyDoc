...
<h1 style="text-align:left">Sign up As Doctor</h1>
</div>
<br>
<br>
<br>
	...
	<div class="row">
      ...
      <div class="col-md-3">
        <div class="text-center">
          ...
          <input style="background-color:#0080ff" class="form-control" type="file">
        </div>
      </div>
      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form" action="DoctorSignUp" method="post">
          <div class="form-group">
            <label class="col-md-3 control-label">First name:</label>
            <div class="col-md-8">
              <input class="form-control" value="" type="text"  name="doctor_name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Last name:</label>
            <div class="col-md-8">
              <input class="form-control" value="" type="text" name="doctor_surname">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Speciality:</label>
            <div class="col-md-8">
              <input class="form-control" value="" type="text" name="doctor_speciality">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Address:</label>
            <div class="col-md-8">
              <input class="form-control" value="" type="text" name="doctor_address">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Region:</label>
            <div class="col-md-8">
              <input class="form-control" value="" type="text" name="doctor_region">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Phone Number:</label>
            <div class="col-md-8">
              <input class="form-control" value="" type="text" name="doctor_phone">
            </div>
          </div>
            <div class="form-group">
              <label class="col-md-3 control-label">Email:</label>
              <div class="col-md-8">
                <input class="form-control" value="" type="email" name="doctor_email">
              </div>
            </div>
          <div class="form-group">
            ...
            <div class="col-md-8">
              <label class="radio-inline" for="Gender-0">
                <input type="radio" name="doctor_gender" id="Gender-0" value="Male" checked="checked">Male
              </label>
              <label class="radio-inline" for="Gender-1">
                <input type="radio" name="doctor_gender" id="Gender-1" value="Female">Female
              </label>
              <label class="radio-inline" for="Gender-2">
                <input type="radio" name="doctor_gender" id="Gender-2" value="Other"> Other
              </label>
            </div>
            </div>
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" value="" type="text" name="doctor_username" >
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Password:</label>
            <div class="col-md-8">
              <input class="form-control" value="" type="password" name="doctor_password">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-3 control-label">Date of Birth:</label>
              <div class="row col-sm-offset-1 col-md-6">
            <select class="form-control col-md-2" id="location" name="doctor_year" placeholder="Year" style="width: 90px;">
            ...
            <select class="form-control col-md-2" id="location" name="doctor_month" placeholder="Month" style="width: 90px;">
            ...
            <select class="form-control col-md-2" id="location" name="doctor_day" placeholder="Day" style="width: 90px;">
              <option value="" disabled selected>Day</option>
              <option value="1">1</option><option>2</option> <option>3</option><option>4</option>  <option>5</option>  <option>6</option>
