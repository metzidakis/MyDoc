...
<div class="container">
  ...
  <h3 style="text-align:center">About Us</h3>
          ...
          <div class="col-md-8">
  <h4 style="text-align:justify"> MyDoc's vision is to make the first contact with the healthcare a pleasant, easy and effective way.
      We offer every user the possibility to find a doctor directly according to their specialty, location and finally to choose the best among the reviews that will read. </h4>
  <h4 style="text-align:justify"> Our team has the expertise, experience and creativity it needs to make MyDoc the most complete tool in dealing with medical issues.</h4>
  <h4 style="text-align:justify"> MyDoc's is not yet a directory of doctors. It is our vision for a more complete, reliable and functional way to manage medical issues, with unique benefits for doctors and patients.
Our team is able to understand your needs and reach the most ideal result at every level.</h4>
  <br>
    <br>
      <br>
