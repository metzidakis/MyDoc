...
<center>
<%if ( ((String)session.getAttribute("loggedinas")).equals("member") ) { %>
<a href="commentform.jsp?dID=<%= doc.getdID() %>" class="btn btn-lg btn-info"><span class="glyphicon glyphicon-share-alt"></span>ADD A COMMENT</a><% } %><a href="#" class="btn btn-lg btn-info"><span class="glyphicon glyphicon-share-alt"></span> SHOW MORE PERSON'S COMMENTS</a>
</center>
</div>
