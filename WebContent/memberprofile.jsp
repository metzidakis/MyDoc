<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
 <%@ page import="classes.Member, classes.Comment, dao.CommentDAO, database.DB, java.sql.Connection, java.sql.PreparedStatement,java.sql.ResultSet,java.sql.SQLException,results.FindDoctors,dao.MemberDAO, classes.Doctor, dao.DoctorDAO, java.util.*" %>  
 ...
 <%
	...
	String sqlquery = "SELECT * FROM member_table where member_id=?;";
	String sqlquery1 = "SELECT * FROM comment_table inner JOIN doctor_table ON doctor_table.doctor_id = comment_table.doctor_id where member_id = ?;";
	...
	try { 
		...
		while (rs1.next()) {
			 ...
			 doctors.add( new Doctor( rs1.getString("doctor_id"), rs1.getString("doctor_username"), rs1.getString("doctor_password"), rs1.getString("doctor_email"), rs1.getString("doctor_name"), rs1.getString("doctor_surname"), rs1.getString("doctor_address"), rs1.getString("doctor_specialty"), rs1.getString("doctor_region"), rs1.getString("doctor_gender"), rs1.getString("doctor_approved"), rs1.getString("doctor_join"), rs1.getString("doctor_yearofbirth")));
		}
...
<h1 style="text-align:left">Member Profile</h1>
</div>
<br>
<br>
<br>
       ...
       <div class="col-md-3">
        <br>
         ...
         <ul class="list-group">
             ...
             <li class="list-group-item text-right lichanger"><span class="pull-left"><strong class="">Joined</strong></span><%= memb.getmJoin() %></li>
             <li class="list-group-item text-right lichanger"><span class="pull-left"><strong class="">Real name</strong></span><%= memb.getmSurname() %><%= memb.getmName() %></li>
             <li class="list-group-item text-right lichanger"><span class="pull-left"><strong class="">Gender</strong></span><%= memb.getmGender() %></li>
             <li class="list-group-item text-right lichanger"><span class="pull-left"><strong class="">Region: </strong></span> <%= memb.getmRegion() %></li>
             </ul>
       </div>
  			...
  			<% for (int i = 0; i < comments.size(); i++){ %>		
  					<div class="row">
  						<div class="col-md-2" "insert">
  							...
  							<div class="review-block-name"><a href="#"><%= memb.getmSurname() %> <%= memb.getmName() %></a></div>
